...
LIB=$PHPR_HOME/lib
#java -server -ea -XX:+AnonymousClasses -XX:+AggressiveOpts -XX:MaxBCEAEstimateLevel=20 -XX:MaxBCEAEstimateSize=1500 -XX:MaxInlineLevel=20 -XX:MaxRecursiveInlineLevel=3 -XX:MaxInlineSize=150 -XX:MaxTrivialSize=25 -XX:PerMethodTrapLimit=1000 -XX:TypeProfileWidth=3 -XX:+UnlockExperimentalVMOptions -XX:+UnlockDiagnosticVMOptions -XX:ScavengeRootsInCode=2 -XX:+EnableInvokeDynamic -XX:MethodHandlePushLimit=5 -Xbootclasspath/p:$LIB/phpreboot.jar:$LIB/tatoo-runtime.jar:$LIB/asm-all-4.0.jar:$LIB/hs19-b01-jsr292-patch.jar:$LIB/grizzly-servlet-webserver-1.9.18-k.jar:$LIB/derby.jar com.googlecode.phpreboot.Main $@
java -server -ea -XX:+AnonymousClasses  -XX:+UnlockExperimentalVMOptions -XX:+EnableInvokeDynamic -Xbootclasspath/p:$LIB/phpreboot.jar:$LIB/tatoo-runtime.jar:$LIB/asm-all-4.0.jar:$LIB/jaxen-1.1.2.jar:$LIB/grizzly-servlet-webserver-1.9.18-k.jar:$LIB/derby.jar com.googlecode.phpreboot.Main $@
